 ...
 */
export async function bundleFunction(name: string, projectRoot: string): Promise<BundleResult> {
...
export async function listFunctions(projectRoot: string): Promise<FunctionInfo[]> {
 ...
 */
export async function isFunctionBuilt(name: string, projectRoot: string): Promise<boolean> {
